# Ready2Golf Account Deletion

If you would like to delete your Ready2Golf account and all associated data, you can do so directly within the app:

1. Open the Ready2Golf app and log in.
2. Navigate to the **Settings** tab.
3. Scroll down to the **Danger Zone** section.
4. Tap **Delete Account** and type "DELETE" to confirm.
